...
The remaining soundness error comes from reducing the evaluation claims for the zerocheck into a single evaluation claim for the dense representation.\footnote{See \texttt{pcs/jagged.py:\_get\_reduction\_error()}.}\\
